...
export const Drawer = ({ setActive, active }) => {
  ...
  return (
    <>
      <div className={
        active ? `md:hidden fixed z-50 h-screen p-3 w-1/2 bg-white transition-all ease-in-out duration-3000 top-0 left-0`
          : `md:hidden fixed z-50 h-screen p-3 w-1/2 bg-white transition-all ease-in-out duration-3000 top-0 -left-full`
      }>
        <div className='flex flex-col h-full'>
          <button type='button' className='text-gray-400 bg-transparent hover:bg-gray-200 rounded-lg text-sm p-1.5 inline-flex 
            items-center dark:hover:bg-gray-600 dark:hover:text-white' onClick={() => setActive(false)}>
